"""
Django settings for HouseServer project.
...
SECRET_KEY = '14t+dre2x8smy-h6#ae@*2dj^tjfj38i=s=4dxgthz$m3k_8ju'
...
ROOT_URLCONF = 'HouseServer.urls'

WSGI_APPLICATION = 'HouseServer.wsgi.application'
